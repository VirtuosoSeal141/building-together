...
@section('title', 'Building Together - Мессенджер')

@section('page-content')
    <x-page-header title="Мессенджер"></x-page-header>
				...
				<div class="col-12 col-lg-7 col-xl-9">
					...
					<div class="flex-grow-0 py-3 px-4 border-top">
						<div class="input-group">
							<input type="text" class="form-control" placeholder="Введите свое сообщение">
