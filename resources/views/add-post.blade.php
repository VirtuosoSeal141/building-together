...
@section('title', 'Building Together - Добавление новости')

@section('page-content')

<x-page-header title="Добавление новости"></x-page-header>

<section class="contact-section section_padding">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">Добавление новости</h2>
        </div>
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="{{route('addpost')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
            <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="title" id="title" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Заголовок новости*'" placeholder = 'Заголовок новости*' value="{{old('title')}}">
                  @error('title')
                    <span class="form__error">Введите заголовок</span>
                  @enderror
                </div>
              </div>
              <div class="col-12">
